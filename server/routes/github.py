...
from shared import _call, _notify, _sanitize, _sql, _sql_param, verify_auth
from shared import IssueCreateRequest, IssueLinkRequest
...
async def create_issue_from_task(body: IssueCreateRequest):
    ...
    result = issue_sync.create_issue(token, repo_full, task["title"], issue_body, label_list, body.assignee or None)
    issue_sync.link_issue(body.task_id, repo_full, result["issue_number"], result["issue_url"], result["html_url"])
